import { GLOBAL_ROUTER_EVENTS_TARGET, matchRoutes, constructAbsolutePath } from 'router-slot';
export class RouteStateController {
    constructor(host, actorState, routerSlot) {
        this.host = host;
...
function getMatchedRoute(routerSlot, url) {
...
//# sourceMappingURL=xstate-route-controller.js.map