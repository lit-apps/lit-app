 ...
 */
export const ProvideEntityStatusMixin = <T extends MixinBase<ReactiveElement>>(
	superClass: T
): MixinReturn<T, EntityStatusMixinInterface> => {
	...
	return ProvideEntityStatusMixinClass;
}
 ...
 * Entity Status stores status information about the entity, like `isDirty`, `isEditing`, `isSaving`, `isLoading`, `isDeleting
 */
export const ConsumeEntityStatusMixin = <T extends MixinBase<ReactiveElement>>(
	superClass: T
): MixinReturn<T, EntityStatusMixinInterface> => {
